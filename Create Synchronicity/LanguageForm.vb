...
#End If
    ...
    Private Sub LanguageForm_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        If LanguagesList.SelectedIndex <> -1 Then ProgramConfig.SetProgramSetting(Of String)(ConfigOptions.Language, LanguagesList.SelectedItem.ToString.Split("-"c)(0).Trim)
    End Sub
